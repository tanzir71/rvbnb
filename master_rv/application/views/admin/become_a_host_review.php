        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="innerWrapper clearfix stepsPage">
                    ...
                    <form class="row" method="POST" action="<?php echo base_url(); ?>admin/host_step_final">
                        ...
                        <div class="col-xs-12">
                            <div class="well well-lg clearfix">
                                <ul class="pagers">
                                    <li class="previous pull-left"><a href="<?php echo base_url(); ?>admin/become_a_host_review" class="hideContent btn btn-danger">back</a></li>
