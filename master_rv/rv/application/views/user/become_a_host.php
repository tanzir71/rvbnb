                        ...
                        <div class="col-xs-12">
                            <div class="well well-lg clearfix">
                                <ul class="pagers">
                                    ...
                                    $host_ch = $this->user_model->host_data_check($this->session->userdata('admin'),$this->session->userdata('session'));
                                    if ($host_ch == FALSE) { ?>
                                        
                                        <li class="next pull-right"><button type="submit" class="btn btn-default">Update</button></li>
                                    <?php }else{ ?>
                                        <li class="previous pull-right"><a href="<?php echo base_url(); ?>user/become_a_host_location" class="btn btn-primary">Continue</a></li>
