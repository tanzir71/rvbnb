                ...
                <div class="container">
                    ...
                    <div class="header-widget pull-right">
                        ...
                        if ($this->session->userdata('admin')) { ?>
                            <a href="<?php echo base_url(); ?>user/become_a_host" class="h-login">Become a Host</a>
                        ...
                        <div class="col-md-offset-1 col-sm-offset-1 col-md-10 col-sm-10 col-lg-10" style="margin-top: 20px;">
                            ...
                            <form class="form-signin" method="post" action="<?php echo base_url(); ?>home/signup">
                                <div class="intro-login">
                                    ...
                                    <input type="password" name="confirm_password" id="con_pass" onclick="con_pass()" placeholder="Enter Confirm Password" required="1">
